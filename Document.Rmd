...
nombre2 <- c("agno", "mes", "region", "cod_caleta", "nombre_caleta", "cod_specie",
...
names(precios2001) <- names(precios2002) <- names(precios2002) <- nombre2
...
temp <- merge(precios1995, precios1996)
