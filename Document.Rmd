...
precios2008     <- read_excel(paste(path, "Precios.xls", sep=""), sheet = 13, skip = 4)
precios2009     <- read_excel(paste(path, "Precios.xls", sep=""), sheet = 14, skip = 4)
precios2010     <- read_excel(paste(path, "Precios.xls", sep=""), sheet = 15, skip = 4)
precios2011     <- read_excel(paste(path, "Precios.xls", sep=""), sheet = 16, skip = 4)
precios2012     <- read_excel(paste(path, "Precios.xls", sep=""), sheet = 17, skip = 4)
precios2013     <- read_excel(paste(path, "Precios.xls", sep=""), sheet = 18, skip = 4)
precios2014     <- read_excel(paste(path, "Precios.xls", sep=""), sheet = 19, skip = 4)

precios2015     <- read_excel(paste(path, "Precios.xls", sep=""), sheet = 20, skip = 5)
precios2016     <- read_excel(paste(path, "Precios.xls", sep=""), sheet = 21, skip = 5)
precios2017     <- read_excel(paste(path, "Precios.xls", sep=""), sheet = 22, skip = 5)
precios2018     <- read_excel(paste(path, "Precios.xls", sep=""), sheet = 23, skip = 5)
